 ...
 * @author top
 */
@XmlRootElement(name = "DmsSeaech")
@XmlAccessorType(XmlAccessType.FIELD)
@ApiModel(description = "ผลลัพท์การค้นหา")
public class DmsSearchModel extends VersionModel {
    ...
    @Since(1.0)
    @Expose 
    private List<String> fileAttachName;
    
    @XmlElement(name = "fullText")
    @ApiParam(name = "fullText", example = "", value = "ข้อมูลในเอกสารแนบ", defaultValue = "", required = false)
    @Since(1.0)
    @Expose 
    private List<String> fullText;
    
    @XmlElement(name = "createName")
    @ApiParam(name = "createName", example = "", value = "ชื่อผู้สร้างเอกสาร", defaultValue = "", required = false)
    @Since(1.0)
    @Expose 
    ...
    @ApiParam(name = "updateName", example = "", value = "ชื่อผู้แก้ไขเอกสาร", defaultValue = "", required = false)
    @Since(1.0)
    @Expose 
    ...
    @ApiParam(name = "removeBy", value = "removeBy", required = false)
    @Since(1.0)
    @Expose
    private int removeBy;
    
    @XmlElement(name = "parentKey")
    @ApiParam(name = "parentKey", value = "parentKey", required = false)
    @Since(1.0)
    @Expose
    ...
    @ApiParam(name = "fullPathName", value = "pathที่อยู่ของเอกสาร", required = false)
    @Since(1.0)
    @Expose
    ...
    @ApiModelProperty(name = "fullText", example = "", dataType = "", value = "ข้อมูลในเอกสารแนบ", required = false)
    ...
    public String getCreateName() {
     ...
     @ApiModelProperty(name = "createName", example = "ผู้ดูแลระบบ", dataType = "string", value = "ผู้ดูแลระบบ", required = false)
    ...
    public String getUpdateName() {
     ...
     @ApiModelProperty(name = "updateName", example = "ผู้ดูแลระบบ", dataType = "string", value = "ผู้ดูแลระบบ", required = false)
    ...
    public int getCreatedBy() {
     ...
     @ApiModelProperty(name = "createdBy", example = "1", dataType = "int", value = "createBy", required = false)
    ...
    @ApiModelProperty(name = "removedBy", example = "1", dataType = "int", value = "removeBy", required = false)
    ...
    @ApiModelProperty(name = "updatedBy", example = "1", dataType = "int", value = "upDateBy", required = false)
...
//    }
    ...
    public List<String> getParentKey() {
     ...
     @ApiModelProperty(name = "parentKey", example = "", dataType = "", value = "parentKey", required = false)
    ...
    public String getType() {
     ...
     @ApiModelProperty(name = "type", example = "C", dataType = "string", value = "C-> ตู้, D-> ,ลิ้นชัก F-> แฟ้ม ,DOC-> เอกสาร", required = false)
    ...
    @ApiModelProperty(name = "fullPathName", example = "ระบบจัดเก็บเอกสาร/สำนักผู้ว่าการ /กองอำนวยการกลาง", dataType = "string", required = false)
